	...
	<div class="bg-img">
		<div class="content" style="width: 40%; height: 83%;">
			...
			<form action="enroll.do" method="post" enctype="multipart/form-data">
				...
				<div class="field space">
					<input type="text" class="pass-key" required placeholder="핸드폰 번호"
				...
				<button
					...
					onclick="emailSend()">인증번호 받기</button>

				<div class="field space" style="width: 80%;">
					<input type="text" class="pass-key" required placeholder="인증키"
						required id="certificationNumber">
				</div>
				<button type="button"
					style="position: absolute; width: 15%; right: 6%; height: 6%; top: 69%;"
					onclick="emailCertification()">인증하기</button>

				<div class="login" id="chK10">※ 인증 후 가입 가능합니다.</div>
				<div class="field space"
					style="margin-left: 19%; margin-top: 10%; height: 65px;">
					<input type="submit" id="chkNo1" value="가입하기"
